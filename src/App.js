...
import ProductsByCategory from "./Page/Products/ProductsByCategoryPage";
import ProductsByBrand from "./Page/Products/ProductsByBrandPage";
    ...
    <div className="font" >
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/admin/orders/:id" element={<AdminOrderDetalisPage />} />npm 
