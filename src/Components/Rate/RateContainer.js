...
const RateContainer = ({ rateAvg, rateQty }) => {
    ...
    return (
        <Container className='rate-container'>
            ...
            {
                allReview?.paginationResult?.numberOfPages >= 2? (<Pagination pageCount={allReview.paginationResult ? allReview.paginationResult.numberOfPages : 0} onPress={onPress} />) : null
              
                // allReview.paginationResult && allReview.paginationResult.numberOfPages
            }
        </Container>
    )
}
