...
import { getProductWishList } from '../../reducx/actions/wishListAction';
    ...
    return (
        <div>
            ...
            <Row className='justify-content-start'>
                {
                    items.length <= 0 ? (<h6>لا يوجد منتجات مفضله حاليا</h6>) : <CardProductsContainer products={items} title="" btntitle="" />
                }
