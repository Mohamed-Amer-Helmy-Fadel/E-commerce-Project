...
import { addProductToWishList, removeProductToWishList } from './../../reducx/actions/wishListAction';
...
const ProductCardHook = (item, favProd) => {
    ...
    let Fav = favProd?.map(fitem => fitem === item._id);
    // console.log('Fav', Fav)
    ...
    // console.log('resRemoveeeee', resRemove.data)
