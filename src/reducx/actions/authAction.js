...
import { CREATE_NEW_USER,RESET_PASSWORD,VERIFY_PASSWORD,UPDATE_USER_PROFILE, FOREGT_PASSWORD,UPDATE_USER_PASSWORD, GET_CURERNT_USER, LOGIN_USER } from '../type'

import { useInsertData } from '../../hooksData/useInsertData'
import { useGetData, useGetDataToken } from '../../hooksData/useGetData';
import { useInsUpdateData } from '../../hooksData/useUpdateData';
